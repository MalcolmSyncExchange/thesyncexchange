...
- admin approves it
- buyer purchases it through Stripe Checkout
...
2. Export the E2E fixture paths:
...
- Stripe Checkout automation still depends on the hosted Checkout surface being reachable locally.
