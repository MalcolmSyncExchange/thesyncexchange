-- Privileged storage policy SQL extracted from the main hosted bootstrap.
--
-- Do not run this as part of the standard hosted Supabase SQL Editor bootstrap.
-- Many hosted projects execute SQL Editor statements as a role that can create
-- public schema objects but does not own storage.objects, which causes the
-- statements below to fail with:
--
--   ERROR: 42501: must be owner of table objects
--
-- Only run this file if you have confirmed the executing role owns
-- storage.objects or has equivalent elevated privileges for storage policy DDL.
