-- Apply these policies manually after creating the buckets documented in
-- supabase/storage-setup.md. This file intentionally manages policies only;
-- it does not create buckets or mutate storage metadata tables.
